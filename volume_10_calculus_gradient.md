...
다음 권은 [Volume 7 — 확률과 통계](./volume_11_probability_statistics.md) 입니다. 거기서는 *모든 ML 손실 함수가 확률 분포에서 유도된다* 는 사실을 이해합니다.
...
[Volume 7 — 확률과 통계](./volume_11_probability_statistics.md)
