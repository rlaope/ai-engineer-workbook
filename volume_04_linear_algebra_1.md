...
실제 시스템은 *인덱스 (FAISS, HNSW)* 로 더 빠르게 만들지만, *수학적 본질* 은 위 두 줄입니다. Vol 35 (벡터 검색과 ANN) 에서 자세히 다룹니다.
...
다음 권은 [Volume 5 — 선형대수 2 — 행렬 분해·고유값·SVD](./volume_05_linear_algebra_2.md) 입니다. 거기서는 행렬을 *세 개의 단순한 행렬의 곱으로 분해* 함으로써 데이터의 본질적 구조를 추출하는 도구를 다룹니다.
