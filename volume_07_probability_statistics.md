...
*베이지안 신경망*·*VAE*·*디퓨전 모델*·*RAG 의 사후 추론* 등 베이즈 사고가 곳곳에 등장합니다. 더 자세한 응용은 Vol 58 (베이지안 ML) 에서 다룹니다.
...
다음 권은 [Volume 8 — 정보 이론](./volume_08_information_theory.md) 입니다. 거기서는 *교차엔트로피와 KL 발산이 왜 그렇게 자주 등장하는가* 를 정보 이론으로 답합니다.
