...
다음 권은 [Volume 9 — 선형대수 2 — 행렬 분해·고유값·SVD](./volume_09_linear_algebra_2.md) 입니다. 거기서는 행렬을 *세 개의 단순한 행렬의 곱으로 분해* 함으로써 데이터의 본질적 구조를 추출하는 도구를 다룹니다.
...
[Volume 9 — 선형대수 2 — 행렬 분해·고유값·SVD](./volume_09_linear_algebra_2.md)
