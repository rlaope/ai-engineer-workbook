...
이 권에서는 Triton 의 자세한 사용법은 다루지 않으며, Vol 100 (CUDA Python 입문) 에서 본격적으로 다룹니다.
...
- *LLM 추론 추적* — Helicone, Langfuse, LangSmith (Vol 90 에서 다룸)
...
다음 권은 [Volume 4 — 선형대수 1 — 벡터·행렬·내적·노름](./volume_04_linear_algebra_1.md) 입니다. 거기서는 모든 데이터를 *벡터·행렬·텐서* 로 추상화해 사고하는 언어를 다룹니다.
